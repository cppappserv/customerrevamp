                ...
                <div class="card">  
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" maxlength="4" class="form-control" name="companycode" id="companycode" placeholder="Company Code .." required="required" value="{{$company->companycode}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" maxlength="40" class="form-control" name="companyname" id="companyname" placeholder="Company Name .." required="required" value="{{$company->companyname}}">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <img src="/company/storeimage/{{ $company->id }}" id="files-tag" width="200px" />  
