...
@section('content')
                    ...
                    <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="left">{{ $p->companyname }}</td>
                                <td  align="left">
                                    <a href="/company/edit/{{ $p->id }}" class="fas fa-pencil-alt"></a>
                                    <a href="/company/delete/{{ $p->id }}" class="fas fa-trash" onclick="return confirm('Are You Sure?');"></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
        ...
        <!-- <div class="modal fade" id="filter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form method="get" action="/company/filter" enctype="multipart/form-data">
