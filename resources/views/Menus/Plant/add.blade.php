        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="card">  
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="/plant/save">
                    {{ csrf_field() }}
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" maxlength="4" pattern="[0-9]{4}" class="form-control" 
                                    name="plantkode" id="plantkode" placeholder="Plant Code .." required="required">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                name="plantname" id="plantname" placeholder="Plant Name .." required="required">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                name="screenmode" id="screenmode" placeholder="Screen Mode .." required="required">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" name="companycode" id="companycode" required="required">
