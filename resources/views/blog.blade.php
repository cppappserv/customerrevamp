								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-4">
											...
											<div class="form-group row">
												<div class="col-sm-12">
													<img src="/storeimage/agent1" id="files-tag" width="80%" style="
																border-radius: 50%;
																margin: auto;">   
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="form-group row">
												...
												<select class="form-control btn btn-default btn-default btn-sm styledatakeluarga" id="inputtipeush" name="inputtipeush" style="font-size: 1rem;;"> 
																											<option value="1" selected>PT</option>
										...
										<div class="col-md-6">
											...
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" id="inputkodesap" name="inputkodesap" placeholder="kode Sap" value="">
												</div>
											</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group row">
												<label for="inputkelrmh" class="col-sm-3 col-form-label">Kelurahan</label>
												<div class="col-sm-9">
													<input type="text" class="form-control" id="inputkelush" name="inputkelush" placeholder="Kelurahan" onchange="mykelurahan(3,this)" name="">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputkecrmh" class="col-sm-3 col-form-label">Kecamatan</label>
							...
							<div class="card card-default">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<div class="input-group">
														<input type="text" id="inputtlpush" name="inputtlpush" class="form-control" data-inputmask="&quot;mask&quot;: &quot;(999) 999-9999&quot;" data-mask="" im-insert="true" value="">
													</div>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<div class="input-group">
														<input type="text" class="form-control" id="inputfaxush" name="inputfaxush" data-inputmask="&quot;mask&quot;: &quot;(999) 999-9999&quot;" data-mask="" im-insert="true"  value="">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-6">
											...
											<div class="form-group row">
												...
												<div class="col-sm-9">
												<!-- tutup -->
													<input type="text" class="form-control" id="inputemailush" name="inputemailush" placeholder="Email" value="" />
												</div>
											</div>
										</div>
										<!-- /.col -->
									...
									<!-- /.row -->
																...
																<input type="hidden" id="optmedsos" value="&lt;option value=&quot;&quot;&gt;-&lt;/option&gt;&lt;option value=&quot;1&quot;&gt;Account ID Medsos&lt;/option&gt;">
							...
							<div class="card card-default">
								...
								<div class="card-body" id="inpareasubagen">
									...
									<!-- /.row -->
										...
										<div class="col-md-2">
											<div class="form-group row kotakexcel_kosong">
												<input type="text" class="form-control" id="inputNamaSubAgen[]" name="inputNamaSubAgen[]" placeholder="Nama" value="1234">
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group row kotakexcel_kosong">
									...
									<!-- /.row -->
										...
										<div class="col-md-2">
											<div class="form-group row kotakexcel_kosong">
												<input type="text" class="form-control" id="inputNamaSubAgen[]" name="inputNamaSubAgen[]" placeholder="Nama" value="SURADI1">
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group row kotakexcel_kosong">
						...
						<div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="custom-content-below-messages-tab">
								...
								<div class="card card-default">
									...
									<div class="card-body" id="inpassetpribadi">
											...
											<div class="col-md-3">
												<div class="form-group row">
													<label for="inputasetpribadirp" class="col-sm-4 col-form-label">CPB Bahari 1</label>
													<div class="col-sm-8">
												...
												<div class="col-sm-12">
													...
													<option value="">Add</option>
																											<option value="1/Rumah/Luas/M2/Alamat/Keterangan lain">Asset Pribadi bentuk Rumah</option>
																												...
																												<option value="7/Mobil/Jenis/-/CPB Bahari 1/-">Asset Pribadi bentuk Mobil</option>
																												<option value="8/Motor/Jenis/-/CPB Bahari 1/-">Asset Pribadi bentuk Motor</option>
																												<option value="9/Kapal/Jenis/-/CPB Bahari 1/-">Asset Pribadi bentuk Kapal</option>
																											</select>
									...
									<div class="card-body">
										<div class="row">
														...
														<div class="form-group row">
															...
															<div class="col-sm-3">
																<input type="text" class="form-control" id="inputmodal[]" name="inputmodal[]" placeholder="%" value="10">	
																<input type="hidden" id="inputmodalid[]" name="inputmodalid[]" value="1">	
															</div>
															<label for="sendiripersent" class="col-sm-2 col-form-label">%</label>
														</div>
													</div>
														...
														<div class="form-group row">
															...
															<div class="col-sm-3">
																<input type="text" class="form-control" id="inputmodal[]" name="inputmodal[]" placeholder="%" value="70">	
										...
										<div class="row" id="rowsmodalbank">
											...
											<div class="col-md-5">
												<div class="form-group row">
													...
													<div class="col-sm-2">
														<!-- <button type="button" name="remove" id="-1" class="btn btn-danger btn_remove9">X</button> -->
													</div>
												</div>
											</div>
							...
							<div class="card card-default">
								...
								<div class="card-body" id="inpjaminan">
										...
										<div class="col-md-2">
											<div class="form-group row">
												<div class="col-sm-12">
													<input type="text" class="form-control" id="inputJaminanPribadi[]" name="inputJaminanPribadi[]" value="Rumah" disabled>	
										...
										<div class="col-md-5">
											<div class="form-group row">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="inputJaminanValue1[]" name="inputJaminanValue1[]" value="2,131" disabled>	
													<input type="hidden" id="inputJaminanValue[]" name="inputJaminanValue[]" value="2,131">
												</div>
										...
										<div class="col-md-3">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" id="inputJaminanAlamat1[]" name="inputJaminanAlamat1[]" value="231231" disabled>	
													<input type="hidden" class="form-control" id="inputJaminanAlamat[]" name="inputJaminanAlamat[]" value="231231">	
												</div>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group row">
												<div class="col-sm-10">
													<input type="text" class="form-control" id="inputJaminanLain1[]" name="inputJaminanLain1[]" value="2312313" disabled>	
													<input type="hidden" class="form-control" id="inputJaminanLain[]" name="inputJaminanLain[]" value="2312313">	
												</div>
												<div class="col-sm-2">
										...
										<div class="col-md-2">
											<div class="form-group row">
												<div class="col-sm-12">
													<input type="text" class="form-control" id="inputJaminanPribadi[]" name="inputJaminanPribadi[]" value="Gudang" disabled>	
										...
										<div class="col-md-5">
											<div class="form-group row">
												<label for="inputbisnislain" class="col-sm-3 col-form-label">Luas</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" id="inputJaminanValue1[]" name="inputJaminanValue1[]" value="2,313,123" disabled>	
													<input type="hidden" id="inputJaminanValue[]" name="inputJaminanValue[]" value="2,313,123">
												</div>
												<label for="inputbisnislain" class="col-sm-3 col-form-label">M2</label>
											</div>
										</div>
										...
										<div class="col-md-2">
											<div class="form-group row">
												<div class="col-sm-12">
													<input type="text" class="form-control" id="inputJaminanPribadi[]" name="inputJaminanPribadi[]" value="Mobil" disabled>	
										...
										<div class="col-md-5">
											<div class="form-group row">
												<label for="inputbisnislain" class="col-sm-3 col-form-label">Jenis</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" id="inputJaminanValue1[]" name="inputJaminanValue1[]" value="3213123" disabled>	
													<input type="hidden" id="inputJaminanValue[]" name="inputJaminanValue[]" value="3213123">
												</div>
												<label for="inputbisnislain" class="col-sm-3 col-form-label"></label>
											</div>
										</div>
										...
										<div class="col-md-2">
											<div class="form-group row">
												<div class="col-sm-12">
													<input type="text" class="form-control" id="inputJaminanPribadi[]" name="inputJaminanPribadi[]" value="Kapal" disabled>	
										...
										<div class="col-md-5">
											<div class="form-group row">
												<label for="inputbisnislain" class="col-sm-3 col-form-label">Jenis</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" id="inputJaminanValue1[]" name="inputJaminanValue1[]" value="214214124124" disabled>	
													<input type="hidden" id="inputJaminanValue[]" name="inputJaminanValue[]" value="214214124124">
												</div>
												<label for="inputbisnislain" class="col-sm-3 col-form-label"></label>
											</div>
										</div>
										...
										<div class="col-md-2">
											<div class="form-group row">
												<div class="col-sm-12">
													<input type="text" class="form-control" id="inputJaminanPribadi[]" name="inputJaminanPribadi[]" value="" disabled>	
										...
										<div class="col-md-5">
											<div class="form-group row">
												<label for="inputbisnislain" class="col-sm-3 col-form-label">Luas</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" id="inputJaminanValue1[]" name="inputJaminanValue1[]" value="200" disabled>	
													<input type="hidden" id="inputJaminanValue[]" name="inputJaminanValue[]" value="200">
												</div>
												<label for="inputbisnislain" class="col-sm-3 col-form-label">M2</label>
											</div>
										</div>
										...
										<div class="col-md-5">
											<div class="form-group row">
												<label for="inputbisnislain" class="col-sm-3 col-form-label">Jenis</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" id="inputJaminanValue1[]" name="inputJaminanValue1[]" value="dwad" disabled>	
													<input type="hidden" id="inputJaminanValue[]" name="inputJaminanValue[]" value="dwad">
												</div>
												<label for="inputbisnislain" class="col-sm-3 col-form-label"></label>
											</div>
										</div>
