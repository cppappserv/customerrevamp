...
// function getUrlsApp($abspath)
// {
    
//     $paths = explode('/', $abspath);
//     //print_r($paths);
//     $path = $paths[count($paths) - 4];
    
//     $url = "";
//     if ($path == 'app-dev') {
//         $url = "http://app-dev.cpp.co.id";
//     } else {
//         $url = "https://app.cpp.co.id";
//     }
//     return $url;
...
{
  // echo "sendCURL";
  $url = "https://rec.localhost/sapapi/".$par["url"];
  // $url = "https://localhost:8000/sapapi/".$par["url"];
  
  // $url = $par["url1"]."/".$par["url"];
  // $url = "http://google.com";
